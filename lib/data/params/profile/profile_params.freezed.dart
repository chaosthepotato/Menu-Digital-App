...
abstract class $ProfileParamsCopyWith<$Res> {
  ...
  @useResult
  $Res call({String? name, String? password, String? phone, String? username});
}
...
class _$_ProfileParams implements _ProfileParams {
  const _$_ProfileParams({this.name, this.password, this.phone, this.username});
  ...
  @override
  String toString() {
    return 'ProfileParams(name: $name, password: $password, phone: $phone, username: $username)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, name, password, phone, username);
...
abstract class _ProfileParams implements ProfileParams {
  const factory _ProfileParams(
      ...
      final String? password,
      final String? phone,
      final String? username}) = _$_ProfileParams;
